...
| Random agent for one arm             |  Trained agents for one arm |
:-------------------------:|:-------------------------:
...
2. Place the file in the GitHub repository, in the folder, and unzip (or decompress) the file. 

3. For Installing this code, you will need to install the dependencies.
